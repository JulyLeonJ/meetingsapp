...
## ___________________________________________________##
    ...
    def save(cls,data): ##metodo de clase 
        query = "INSERT INTO reuniones (titulo,duracion,lugar,organizador,hora,disponibilidad,id_invitado) VALUES (%(titulo)s,%(duracion)s,%(lugar)s,%(organizador)s,%(hora)s,%(disponibilidad)s,%(id_invitado)s))"
        return connectToMySQL('reuniones_schema').query_db(query,data)
...
## ___________________________________________________##
    ...
    def get_one(cls,data):
        ...
        reuniones_from_db = connectToMySQL('reuniones_schema').query_db(query,data)
...
## ___________________________________________________##
    ...
    def get_all(cls):
        ...
        reuniones_from_db =  connectToMySQL('reuniones_schema').query_db(query)
        reuniones =[]
        for b in reuniones_from_db:
          reuniones.append(cls(b))
        return reuniones
